...
## v1.0.5
- It has come to my attention that someone else want SnapToTheNearest45 so here is it. Check the setting
## v1.0.4
...
## v1.0.1
- It has come to my attention that the original approach was terrible for a number of reasons.
## v1.0.1-beta.1
- Basic housekeeping.
## v1.0.0
